import { JukeboxCard } from './Sidebar.jsx';

export default function MobileVoiceView({ voiceChannel, voiceChannelName, voiceMembers, voiceState, user }) {
  const {
      ...
      <div className="flex-1 overflow-y-auto p-4">
        <div className="grid grid-cols-3 gap-4 max-w-sm mx-auto">
          {members.map((member) => {
            ...
            return (
              <div key={member.socketId} className="flex flex-col items-center gap-1.5">
